...
"""
        ...
        if cursor_row == line_index:
            ...
            if draw_cursor:
                ...
                if cursor_style:
                    cursor_end = (
                        cursor_column + 1
                        if cursor_column >= line_character_count
                        else next_grapheme_boundary(
                            self.document[line_index], cursor_column
                        )
                    )
                    line.stylize(cursor_style, cursor_column, cursor_end)
    ...
    def get_cursor_word_left_location(self) -> Location:
        ...
        return cursor_row, text_area_word_left(line, cursor_column)
    ...
    def get_cursor_word_right_location(self) -> Location:
        ...
        return cursor_row, text_area_word_right(line, cursor_column)
    ...
    def action_delete_word_right(self) -> None:
        ...
        self._delete_via_keyboard(end, self.get_cursor_word_right_location())
